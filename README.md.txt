...
-Build a web app for photojournalists to sell their content directly to media.

### Links

- URL: [Github live page for my portfolio](https://joacocw.github.io/PhotoWebApp/)
- URL: [Joaco´s porfolio](https://joacocw.github.io/PhotoWebApp/)

## My process

I started with the idea and got help from a UX/UI designer in order to take it to a wireframe. After that i worked on the structure and styled it.
